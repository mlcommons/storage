...
- [x] **VER-01**: `mlpstorage version` prints the installed package version and exits 0
...
- [x] **VER-03**: `mlpstorage version` is a top-level sibling of closed/open/whatif (not nested under them)
